...
#SBATCH --array=0-1
#SBATCH --output=/home/ansonl32/ECE405/ece405-assignment3-alignment/cs336_alignment/outputs/logs/grpo_baseline_%A_%a.out
#SBATCH --error=/home/ansonl32/ECE405/ece405-assignment3-alignment/cs336_alignment/outputs/logs/grpo_baseline_%A_%a.err
...
BASELINES=(no_baseline reinforce_with_baseline)
...
OUT_DIR="/home/ansonl32/koa_scratch/ECE405/assignment3/qwen_grpo_final/grpo_baseline_${BASELINE}"
RUN_NAME="GRPO_baseline_${BASELINE}_lr${LR}"
mkdir -p "${OUT_DIR}"

echo "Job ${SLURM_JOB_ID}, task ${SLURM_ARRAY_TASK_ID}: BASELINE=${BASELINE}  lr=${LR}"
